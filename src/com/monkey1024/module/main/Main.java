 ...
 */
package com.monkey1024.module.main;

import com.gn.GNAvatarView;
import com.monkey1024.global.factory.AlertCell;
...
public class Main implements Initializable {
    ...
    private String path = "/com/monkey1024/theme/css/";
    ...
    private void addSubPop() throws Exception {
        popup.setContentNode(FXMLLoader.load(getClass().getResource("/com/monkey1024/module/main/Popover.fxml")));
    ...
    private void addEvent(Node node) {
        ...
        scrollPane.getStylesheets().add(getClass().getResource("/com/monkey1024/theme/css/custom-scroll.css").toExternalForm());
...
//        Popover.ctrl.options.getChildren().clear();
    ...
    private void loadContentPopup() {
        try {
            popContent = FXMLLoader.load(getClass().getResource("/com/monkey1024/module/main/Config.fxml"));
            popConfig.getRoot().getStylesheets().add(getClass().getResource("/com/monkey1024/theme/css/poplight.css").toExternalForm());
    ...
    private void openMessages() {
        if (!pop.isShowing()) {
            ...
            avatar1.setImage(new Image(getClass().getResource("/com/monkey1024/module/media/man.png").toExternalForm()));
            avatar2.setImage(new Image(getClass().getResource("/com/monkey1024/module/media/woman.png").toExternalForm()));
            avatar3.setImage(new Image(getClass().getResource("/com/monkey1024/module/media/man.png").toExternalForm()));
            ...
            listView.getStylesheets().add(getClass().getResource("/com/monkey1024/theme/css/custom-scroll.css").toExternalForm());


            pop.getRoot().getStylesheets().add(getClass().getResource("/com/monkey1024/theme/css/poplight.css").toExternalForm());
    ...
    private void openNotification() {
        if (!pop.isShowing()) {
            ...
            avatar1.setImage(new Image(getClass().getResource("/com/monkey1024/module/media/warning-35.png").toExternalForm()));
            avatar2.setImage(new Image(getClass().getResource("/com/monkey1024/module/media/error-35.png").toExternalForm()));
            avatar3.setImage(new Image(getClass().getResource("/com/monkey1024/module/media/notification-35.png").toExternalForm()));
