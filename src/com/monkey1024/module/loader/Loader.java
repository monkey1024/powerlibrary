 ...
 */
package com.monkey1024.module.loader;
...
public class Loader extends Preloader {
    ...
    public void init(){
        try {
            view = FXMLLoader.load(getClass().getResource("/com/monkey1024/module/loader/loader.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void start(Stage primary){
        ...
        scene.getStylesheets().add(getClass().getResource("/com/monkey1024/theme/css/fonts.css").toExternalForm());
        progressBar = (JFXProgressBar) scene.lookup("#progressBar");
        primary.getIcons().add(new Image("/com/monkey1024/module/media/icon.png"));
